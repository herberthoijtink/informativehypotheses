...
We will be using the \emph{Approximate Adjusted Fractional Bayes factor} proposed by \citet{gu2018approximated}, which is implemented in the R package \texttt{bain} \citep{bain}.
